var Version = "1",
    AppVersion = "?" + Version,
    APIRoot = "https://localhost:44325/api/",
    loaderTimeOut,
...
async function FetchResources() {
    fetch("JS/API.js" + AppVersion)
        ...
        .then(async () => {
            var FethingFiles = [
                [API.get("CSS/Main.css" + AppVersion), "css"],
                [API.get("CSS/alert.css" + AppVersion), "css"],
                [API.get("CSS/Grid.css" + AppVersion), "css"],
                [API.get("Resources/fontawesome-free-5.12.0-web/css/all.css"), "css"],
                [API.get("JS/Alert.js" + AppVersion), "script"],
                [API.get("JS/DateTextbox.js" + AppVersion), "script"],
                [API.get("JS/PartialViewLoader.js" + AppVersion), "script"],
                [API.get("JS/Promise-based-indexedDB.js" + AppVersion), "script"],
                [API.get("JS/Sheikhloo.js" + AppVersion), "script"],
                [API.get("JS/SocketManager.js" + AppVersion), "script"],
                [API.get("JS/Notification.js" + AppVersion), "script"],
                [API.get("JS/Grid.js" + AppVersion), "script"],
                [API.get("JS/AutoComplete.js" + AppVersion), "script"],
                [API.get("JS/Scripts.js" + AppVersion), "script"],
